                    ...
                    <div class="panel-body">
                    	<form role="form" class="form-product form-horizontal" method="POST" action="{{route('admin.product.postadd')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="ten_sanpham" class="ten_sanpham form-control"> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="cong_suat" class="cong_suat form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Kích thước</label>
                                <div class="col-sm-4">
                                    <input type="text" name="kich_thuoc" class="kich_thuoc form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Khoét lỗ</label>
                                <div class="col-sm-4">
                                    <input type="text" name="khoet_lo" class="khoet_lo form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Giá</label>
                                <div class="col-sm-4">
                                    <input type="text" name="gia" class="gia form-control">
                                </div>
                            </div>
                            <div class="form-group">
