  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">HomeHiTech</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#portfolio">Thông Tin Sản Phẩm</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#about">Giải Pháp</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team">Nhân Viên Công Ty</a>
                    </li>
                    <li>
    ...
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
            ...
            <div class="row animated light1-amination" style="margin-right: 3%;">
                <ul style="list-style: none;margin-bottom: 10%;" class="format-ul">
                    <li class="format-li active light1">
                        Đèn âm trần
                    </li>
                    <li class="format-li light2">
                        Đèn trang trí
                    </li>
                </ul>
            </div>
            ...
            <div class="row animated light2-amination" style="margin-right: 3%;">
                <ul style="list-style: none;margin-bottom: 10%;" class="format-ul">
                    <li class="format-li active light1">
                        Đèn âm trần
                    </li>
            ...
            <div class="row animated light2-amination hidden">
    ...
    <div id="fb-root"></div>
      ...
      <style>
        #cfacebook{position:fixed;bottom:0px;right:10px;z-index:2;width:250px;height:auto;box-shadow:6px 6px 6px 10px rgba(0,0,0,0.2);overflow:hidden;}
